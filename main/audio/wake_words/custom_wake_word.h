...
public:
    ...
    bool IsCustomWakeWord() const override { return true; }
...
private:
    ...
    void RefreshActiveCommands();
    bool PersistCurrentConfig() const;
    bool DeserializeCommands(const std::string& json, std::deque<Command>& commands) const;
    std::string SerializeCommands(const std::deque<Command>& commands) const;
};
