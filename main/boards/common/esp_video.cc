...
#ifdef CONFIG_BAJI_ENABLE_CAMERA_DEBUG_MODE
#undef LOG_LOCAL_LEVEL
#define LOG_LOCAL_LEVEL MAX(CONFIG_LOG_DEFAULT_LEVEL, ESP_LOG_DEBUG)
#endif  
#include <esp_log.h> 

#ifdef CONFIG_BAJI_ENABLE_ROTATE_CAMERA_IMAGE
#ifdef CONFIG_IDF_TARGET_ESP32P4
#include "driver/ppa.h"
#if defined(CONFIG_BAJI_CAMERA_IMAGE_ROTATION_ANGLE_90)
#define IMAGE_ROTATION_ANGLE (PPA_SRM_ROTATION_ANGLE_270)
#elif defined(CONFIG_BAJI_CAMERA_IMAGE_ROTATION_ANGLE_270)
#define IMAGE_ROTATION_ANGLE (PPA_SRM_ROTATION_ANGLE_90)
#else
#error "CONFIG_BAJI_CAMERA_IMAGE_ROTATION_ANGLE is not set"
#endif  
#else   
...
#if defined(CONFIG_CAMERA_SENSOR_SWAP_PIXEL_BYTE_ORDER) || defined(CONFIG_BAJI_ENABLE_CAMERA_ENDIANNESS_SWAP)
#warning \
    "CAMERA_SENSOR_SWAP_PIXEL_BYTE_ORDER or CONFIG_BAJI_ENABLE_CAMERA_ENDIANNESS_SWAP is enabled, which may cause image corruption in YUV422 format!"
#endif

#if CONFIG_BAJI_ENABLE_CAMERA_DEBUG_MODE
...
#if defined(CONFIG_BAJI_ENABLE_ROTATE_CAMERA_IMAGE) && defined(CONFIG_SOC_PPA_SUPPORTED)
    auto get_rank = [](uint32_t fmt) -> int {
        switch (fmt) {
            ...
            case V4L2_PIX_FMT_RGB565:
                return 1;
#ifdef CONFIG_BAJI_ENABLE_HARDWARE_JPEG_ENCODER
    ...
    auto get_rank = [](uint32_t fmt) -> int {
        switch (fmt) {
            ...
            case V4L2_PIX_FMT_YUV420:
                return 13;
#endif  
#ifdef CONFIG_BAJI_CAMERA_ALLOW_JPEG_INPUT
    ...
    for (int i = 0; i < 3; i++) {
        ...
        if (i == 2) {
            ...
            switch (sensor_format_) {
                ...
                case V4L2_PIX_FMT_JPEG:
#endif  
#ifdef CONFIG_BAJI_ENABLE_CAMERA_ENDIANNESS_SWAP
                {
