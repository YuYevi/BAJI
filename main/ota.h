...
public:
    ...
    bool HasMqttControlConfig() { return has_mqtt_control_config_; }
    ...
    static UpgradeResult UpgradeWithResult(const std::string& firmware_url,
...
private:
    ...
    bool has_mqtt_control_config_ = false;
