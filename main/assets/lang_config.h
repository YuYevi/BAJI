...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char ogg_inform_start[] asm("_binary_inform_ogg_start");
        extern const char ogg_inform_end[] asm("_binary_inform_ogg_end");
        static const std::string_view OGG_INFORM {
        static_cast<const char*>(ogg_inform_start),
        static_cast<size_t>(ogg_inform_end - ogg_inform_start)
        };
